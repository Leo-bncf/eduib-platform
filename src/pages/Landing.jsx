      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 mx-auto max-w-4xl">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-slate-200 rounded-xl overflow-hidden border border-slate-200 shadow-sm">
            ...
            <div className="bg-white px-8 py-7 text-center">
              <div className="text-3xl font-bold text-purple-700 mb-2">Zero noise</div>
    ...
    <section className="py-24 bg-slate-50 border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {roles.map((r, i) => (
            <div key={i} className="relative p-6 bg-white border-t-2 border-t-purple-500 shadow-sm rounded-b-md border-x border-b border-slate-200">
