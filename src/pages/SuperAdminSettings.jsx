...
import { CheckCircle2, Loader2, Palette, Settings, SlidersHorizontal } from 'lucide-react';
  ...
  return (
    <SuperAdminShell activeItem="settings" currentUser={currentUser}>
      <SuperAdminPageHeader
        ...
        subtitle="Manage global defaults, branding rules, and platform feature rollout"
        actions={
          <Button
